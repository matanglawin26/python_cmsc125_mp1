...
class Simulation:
    ...
    # def is_complete(self, curr_user):
    #     print("CURR USER: %d" % curr_user.id, "IN PROCESS?: ",self.__process.get(curr_user))
    #     if len(curr_user.req_list()) == 0 and not self.__process.get(curr_user):
    #         return True
    #     return False
    #     # return False if self.__res_list else True
